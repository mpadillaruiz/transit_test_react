...
class Map extends React.Component {
  ...
  componentDidMount() {
    ...
    this.legend.onAdd = function (map) {
        ...
        //Adding subway lines
        div.innerHTML +='<i style="background:' + '#000000' + '"></i> ' +
            '<span>Subway Line</span>' + '<br>';
        //Adding subway stops
        div.innerHTML +='<img src="assets/images/icon.png" alt="subway" height="20" width="20">'  +
          '<span>Subway Stop</span>' + '<br>';
        return div;
    };
